        ...
        <div className="row my-5">
          ...
          <div className="col-9 d-flex" style={{marginBottom: '50px'}}>
            ...
            <div className="col-6 text-center">
              ...
              <button onClick={() => aboutDog()} style={{ paddingRight: '60px', paddingLeft: '60px', borderRadius: '25px' }} className="my-3 btn btn-primary">ABOUT DOG</button>
            </div>
            <div className="col-6 text-center">
              ...
              <button onClick={() => aboutCat()} style={{ paddingRight: '60px', paddingLeft: '60px', borderRadius: '25px' }} className="my-3 btn btn-primary">ABOUT CAT</button>
            </div>
