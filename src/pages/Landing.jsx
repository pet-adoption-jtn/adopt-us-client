        ...
        <div className="row">
          ...
          <div className="col-9 d-flex" style={{marginBottom: '50px'}}>
            ...
            <div className="col-6 text-center">
              <img src="https://images.squarespace-cdn.com/content/v1/5cd493f1185add0001e4670d/1558988155986-PY602J3JHUN77WUMVRXS/ke17ZwdGBToddI8pDm48kFyD7pzB8zoMIVY5aiUuFlp7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0jG2lbcDYBOeMi4OFSYem8DMb5PTLoEDdB05UqhYu-xbnSznFxIRsaAU-3g5IaylIg/image-asset.jpeg?format=2500w" width="100%" height="350" className="rounded w3-card-4" alt="baba" style={{ borderColor: '#f0199a' }} />
              <button style={{ paddingRight: '120px', paddingLeft: '120px', borderRadius: '25px' }} className="mt-4 mb-4 btn btn-1 btn-lg">ABOUT DOG</button>
            </div>
            <div className="col-6 text-center">
              <img src="https://catrescue.id/wp-content/uploads/2020/01/cat-rescue-03.jpg" width="100%" height="350" className="rounded w3-card-4" alt="" style={{borderColor: '#f0199a'}} />
              <button style={{ paddingRight: '120px', paddingLeft: '120px', borderRadius: '25px' }} className="mt-4 mb-4 btn btn-1 btn-lg">ABOUT CAT</button>
            </div>
