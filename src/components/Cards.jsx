    ...
    <>
      <div className="col-4 mb-3">
        <div className="card text-center shadow" style={{width: '16rem'}}>
          <img src="https://upload.wikimedia.org/wikipedia/commons/a/a0/000_American_Pit_Bull_Terrier.jpg" width="500px" height="200px" className="card-img-top" alt="..." />
          <div className="card-body">
            <div className="d-flex" style={{justifyContent: 'flex-end'}}>
              <p><i className="icon-heart shadow fa fa-heart-o" style={{fontSize: '24px', fontWeight: '600', color: '#ce0d81'}}></i></p>
            </div>
